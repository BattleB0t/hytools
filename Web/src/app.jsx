		...
		return <div>
			<Router>
				<Switch>
					...
					<Route path="/stats/bedwars" exact component={() => <BedwarsStats />} />
					<Route path="/skyblock/sbmoney" exact component={() => <SkyblockMoney />} />
					<Route path="/marketplace" exact component={() => <MarketPlace />} />
					<Route path="/settings" exact component={() => <Settings />} />
					<Route path="/info/unofficial" exact component={() => <InfoPage />} />
